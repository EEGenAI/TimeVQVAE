...
class ExpStage2(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        mask_pred_loss, (mask_pred_loss_l,
                         mask_pred_loss_h) = self.maskgit(x, y)
    ...
    def configure_optimizers(self):
        ...
        scheduler = linear_warmup_cosine_annealingLR(
            opt, self.config['trainer_params']['max_steps']['stage2'], self.config['exp_params']['linear_warmup_rate'], min_lr=self.config['exp_params']['min_lr'])
