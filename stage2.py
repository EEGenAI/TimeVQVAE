...
def load_args():
    ...
    parser.add_argument('--feature_extractor_type', type=str,
                        default='supervised_fcn', help='rocket | rocket for evaluation.')
...
def train_stage2(config: dict,
    ...
    train_exp = ExpStage2(dataset_name, in_channels, input_length,
    ...
    trainer.save_checkpoint(os.path.join(
        f'saved_models', f'stage2-{dataset_name}.ckpt'))
    ...
    evaluation.log_visual_inspection(
        evaluation.X_test, x_gen, 'X_test vs Xhat')
...
if __name__ == '__main__':
    ...
    for dataset_name in dataset_names:
        ...
        # train
        train_stage2(config, dataset_name, train_data_loader, test_data_loader,
