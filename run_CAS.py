...
def load_args():
    ...
    parser.add_argument('--config_cas', type=str, help="Path to the config_cas data  file.",
                        default=get_root_dir().joinpath('configs', 'config_cas.yaml'))
    ...
    parser.add_argument('--min_n_synthetic_train_samples', type=int, default=1000,
                        help='It ensures a minimum number of a number of synthetic training set size to guarantee `y ∼ pθ(y|x) = pθ(x|y)p(y)/pθ(x)`.')
...
if __name__ == '__main__':
    ...
    for dataset_name in dataset_names:
        ...
        real_train_data_loader, real_test_data_loader = [build_data_pipeline(
